...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-notify-app-mobile.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-notify-app-mobile)

This repository contains the source code for the [connectatech](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.notify.app.mobile).

Please see the [issues](https://github.com.notify.app.mobile/com-notify-app-mobile/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about connectatech? Ask away on the [com-notify-app-mobile discussion forum](https://groups.google.com/forum/#!forum/com-notify-app-mobile).

<a href="https://play.google.com/store/apps/details?id=com.notify.app.mobile" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.notify.app.mobile__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.notify.app.mobile__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.notify.app.mobile.R__) will now be renamed
...
signed with a different key.  Manually uninstall connectatech from your device and
...
connectatech is a result of a template project I've developed over the years as well as
...
connectatech is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.notify.app.mobile/com-notify-app-mobile/contributors) on
...
[pull requests](https://github.com.notify.app.mobile/com-notify-app-mobile/pulls).
